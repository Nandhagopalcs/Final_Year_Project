...
function createDownloadLink(blob) {
    ...
    var breathshallow = document.getElementById('surv_breathshallow')
    ...
    upload.addEventListener("click", function(event){
          ...
          xhr.open("POST","/surv_breath_shallow",true);
          xhr.send(fd);
    })
    li.prepend(br)
...
function createDownloadLink2(blob) {
    ...
    upload2.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_breath_deep",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
...
function createDownloadLink3(blob) {
    ...
    upload3.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_cough_shallow",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
...
function createDownloadLink4(blob) {
    ...
    upload4.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_cough_heavy",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
...
function createDownloadLink5(blob) {
    ...
    upload5.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_vowel_a",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
...
function createDownloadLink6(blob) {
    ...
    upload6.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_vowel_e",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
...
function createDownloadLink7(blob) {
    ...
    upload7.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_vowel_o",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
...
function createDownloadLink8(blob) {
    ...
    upload8.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_counting_normal",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
...
function createDownloadLink9(blob) {
    ...
    upload9.addEventListener("click", function(event){
          ...
          var fd=new FormData();
          fd.append("audio_data",blob, filename);
          xhr.open("POST","/surv_counting_fast",true);
          xhr.send(fd);
    })
    li.prepend(br)
    li.appendChild(document.createTextNode (" "))//add a space in between
